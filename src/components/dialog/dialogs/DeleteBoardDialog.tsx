...
export function DeleteBoardDialog({ isOpen }: { isOpen: boolean }): JSX.Element {
					...
					<div className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
						...
						>
							<Dialog.Panel className='bg-white py-10 px-8 relative my-auto h-40 w-20 transform overflow-hidden rounded-lg text-left shadow-xl transition-all dark:bg-gray-800 sm:my-8 md:h-full md:w-10/12 lg:w-[480px]'>
								<h2 className='mb-6 text-base-red text-xl font-semibold'>Delete this board?</h2>
								...
								<div className='grid grid-cols-2 gap-3 mt-6'>
									...
									<button className='py-2 px-4 bg-main-purple font-semibold text-main-purple dark:bg-white bg-opacity-10 rounded-full'>
										Cancel
									</button>
								</div>
							</Dialog.Panel>
